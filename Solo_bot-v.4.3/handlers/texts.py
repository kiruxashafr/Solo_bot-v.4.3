...
# Текст главного меню
WELCOME_TEXT = (
    "<b>Protons VPN. Заряжен свободой. Создан для скорости. Безопасность в твоих руках.</b>\n\n"
    "🚀 <b>Высокая скорость</b>\n"
    "🔄 <b>Стабильность</b>\n"
    "🌍 <b>Смена локаций</b>\n"
    "💬 <b>Отзывчивая поддержка</b>\n"
    "📱 <b>Для телефонов, компьютеров и планшетов</b>\n"
    "🎁 <b>Получи 75 рублей на баланс за каждого реферала</b>\n\n"
...
def tariff_message():
    return (
        "📡 <b>Тарифы</b>\n\n"
        "<b>Все подписки включают подключение до 5 устройств — одного аккаунта достаточно для всех ваших устройств.</b>\n\n"
        "📅 <b>1 месяц</b> — 149₽\n"
        "📅 <b>3 месяца</b> — 419₽ (скидка 5%)\n"
        "📅 <b>6 месяцев</b> — 799₽ (скидка 10%)\n"
        "📅 <b>12 месяцев</b> — 1499₽ (скидка 15% 🔥)\n\n"
...
def get_about_vpn(bot_version: str):
    return (
        ...
        "🛠<b> Есть вопрос?</b> Обращайся в <a href='https://t.me/ProtonsVPN_support_bot'>поддержку</a>"
    )
...
def profile_message_send(username, tg_id, balance, key_count):
    ...
    profile_message += (
        ...
        f"Следите за новостями и обновлениями! 👉 <a href='{CHANNEL_URL}'>Канал</a>\n"
...
TOP_REFERRALS_TEXT = (
    "Здесь можно увидеть топ людей, которые пригласили наибольшее количество рефералов.\n\n"
...
GIFTS_ABOUT = "<b>Подарите VPN и следите, чтобы он дошёл до адресата! 👀</b>"
